...
const WeeklyPowerAnalysis = () => {
    ...
    const search_address = "dataanalysis/weeklypoweranalysis-r";
    ...
    const formatChartData = (data) => {
        const labels = data.map(item => item.collectdate);
            ...
            <Card noborder>
                <div className="ltr:pr-4 rtl:pl-4 flex item-center">
                    ...
                    <Auto_Button_Question
                        description="조회된 기간을 기준으로 7일간의 전력 데이터를 바탕으로 총 사용전력, 최대부하, 목표 사용량, 목표대비 사용량을 나타냅니다."
                    />
                </div>
            ...
            <Card noborder>
                <div className="flex justify-between items-center mb-5">
                    <div className="text-xl">
                        <span className="mr-2">주간 전력 추이</span>
                        <Auto_Button_Question
...
export default WeeklyPowerAnalysis;