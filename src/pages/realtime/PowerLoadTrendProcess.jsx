...
const PowerLoadTrendProcess = () => {
    ...
    const searchinfo = useMemo(
        () => ({
            address: "realtime/powerloadtrendprocess-r",
            params: {
    ...
    useEffect(() => {
        const loadDropdownData = async () => {
            try {
                const [plantcodeAll, plantcodeRequired, processcodeRequired] =
                    await Promise.all([
...
export default PowerLoadTrendProcess;