...
const ProcessMaster = () => {
  ...
  const searchinfo = useMemo(
    () => ({
      address: "baseinfo/processmaster-r",
      params: {
  ...
  const columnDefs = useMemo(
    () => [
      ...
      { field: "processname", headerName: "공정명", editable: true, minWidth: 100, },
      ...
      { field: "udc1", headerName: "udc1", editable: true, hide: true },
      { field: "udc2", headerName: "udc2", editable: true, hide: true },
      { field: "udc3", headerName: "udc3", editable: true, hide: true },
      { field: "udc4", headerName: "udc4", editable: true, hide: true },
      { field: "udc5", headerName: "udc5", editable: true, hide: true },
          ...
          <div className="flex flex-col gap-y-1">
            <div className="flex flex-wrap gap-x-24 items-center gap-y-1">
              ...
              <Auto_Label_Text_Set
                ...
                onChange={(e) => updateSearchParams("processid", e.target.value)}
                labelSpacing={'-mr-5'}
              ...
              <Auto_Label_Text_Set
                ...
                onChange={(e) => updateSearchParams("processname", e.target.value)}
                labelSpacing={'-mr-5'}
                setEnterSearch={setEnterSearch}
              />
              <Auto_Radio_Useflag
          ...
          <div className="flex justify-between mb-5">
            ...
            <div className="flex space-x-2">
              ...
              <Auto_Button_Save_AGgrid
                ...
                modifyAddress="baseinfo/processmaster-cud"
                setExcuteSuccesAndSearch={setExcuteSuccesAndSearch} 
                gridRef={gridRef}
              />
            </div>
