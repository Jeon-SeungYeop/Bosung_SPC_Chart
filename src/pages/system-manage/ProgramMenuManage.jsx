...
const ProgramMenuManage = () => {
  ...
  //////////////////////////////////////////////////////////////////////// 화면 별 유동 설정 필드 멤버 ////////////////////////////////////////////////////////////////////////
  const primaryKeys = ["plantcode", "menuid"]; // 그리드 의 기본 키  
  ...
  useEffect(() => {
    const loadDropdownData = async () => {
      try {
        const [plantcodeAll, plantcodeRequired, menutypeAll] =
          await Promise.all([
            ...
            DropDownItemGetter(apiUrl, { param1: "common", param2: "1000", param3: "menutype", param4: "X" }),
          ]);
        ...
        setDropdownData({
          ...
          menutype: { items: menutypeAll, mappings: CommonFunction.convertData(menutypeAll) },
        });
      } catch (error) {
      }
    };
    ...
    () => [
      {
        ...
        cellEditorParams: { values: Object.values(dropdownData.plantcode.mappings) }, // 드롭다운 콤보박스 세팅.
        // 드롭다운 세팅
      ...
      { field: "menuid",  headerName: "매뉴ID",editable : false, minWidth: 80,}, // 매뉴 타입에 따라 자동 채번  
      { field: "menuname", headerName: "매뉴CODE", editable: true, minWidth: 150, },
      { field: "menutitle", headerName: "매뉴이름", editable: true, minWidth: 170, }, 
      { field: "iconaddress", headerName: "아이콘주소", editable: true, minWidth: 130, },
      { field: "url", headerName: "URL", editable: true, minWidth: 150, },
          ...
          <div className="flex flex-col gap-y-1">
            ...
            <Auto_SearchDropDown
              ...
              <Auto_Label_Text_Set
                ...
                onChange={(e) => updateSearchParams("menuname", e.target.value)}
                labelSpacing={'-mr-5'}
          ...
          <div className="flex justify-between mb-5">
            ...
            <div className="flex space-x-2 ">
              ...
              <Auto_Button_Save_AGgrid
                ...
                modifyAddress="sys/programmenu-cud"
                setExcuteSuccesAndSearch={setExcuteSuccesAndSearch}
                gridRef={gridRef}
                setAddData={setAddData}
              />
...
export default ProgramMenuManage;
