import {
  ...
  Auto_Button_Import_Excel, Auto_LabelPopup_Set, Auto_DateTimePickerF_T, Auto_Button_Column_State
...
const UserConnectionHistory = () => {
  ...
  //////////////////////////////////////////////////////////////////////// 화면 별 유동 설정 필드 멤버 ////////////////////////////////////////////////////////////////////////
  const primaryKeys = ["plantcode", "userid"]; // 그리드 의 기본 키
  ...
  const searchinfo = useMemo(
    () => ({
      address: "sys/userconnecthistory-r",
      params: {
        plantcode: searchParams.plantcode?.value ?? "",
        userid: searchParams.workerid ?? "",
        username: searchParams.workername ?? "",
  ...
  const columnDefs = useMemo(
    () => [
      ...
      { field: "userid",  headerName: "사용자ID",editable: false, minWidth: 130,},
      { field: "username", headerName: "사용자명", editable: false, minWidth: 130,},
      { field: "useraction", headerName: "활동구분", editable: false, minWidth: 130,},
      { field: "makedate", headerName: "일시", editable: false, minWidth: 170,}, 
      { field: "remark", headerName: "비고", editable: false, minWidth: 130, },
      { field: "ipaddress", headerName: "접속IP", editable: false, minWidth: 130,},
    ],
    [dropdownData]
  );
