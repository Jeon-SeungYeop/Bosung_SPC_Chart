...
import Image1 from "@/components/assets/images/all-img/cus-1.png";
import Image2 from "@/components/assets/images/all-img/cus-2.png";
import Image3 from "@/components/assets/images/all-img/cus-3.png";

import Cuser1 from "@/components/assets/images/users/user-1.jpg";
import Cuser2 from "@/components/assets/images/users/user-2.jpg";
import Cuser3 from "@/components/assets/images/users/user-3.jpg";
import customerCrownImage from "@/components/assets/images/icon/crown.svg";
const Customer = () => {
  const customers = [
    {
      title: "Nicole Kidman",
