...
/////////////////////////////////// 동, 공정 필수 선택이 되는 컴포넌트는 search1 컴포넌트로////////////////////////////////////////////////////
const Bosung_equipmentid_search4 = ({adress, setGridData, excuteSuccesAndSearch, isDate, oneDate = false, isYear, isDivision}) => {
    ...
    useEffect(() => {
        const loadDropdownData = async () => {
            try {
                const [plantcodeAll, plantcodeRequired, sitecodeAll, sitecodeRequired, processAll, processRequired] = await Promise.all([
                ...
                setDropdownData((prev) => ({
                    ...
                    process: { items: processAll, mappings: CommonFunction.convertData(processRequired) },
                }));
            } catch (error) {
...
export default Bosung_equipmentid_search4;