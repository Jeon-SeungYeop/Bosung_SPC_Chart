  ...
  return (
    <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
      ...
      <Card title="Router Link">
        <div className="space-xy-5">
          <Button text="primary" className="btn-primary" link="/IntegratedDashboard" />
          <Button
            text="secondary"
            className=" btn-secondary"
            link="/IntegratedDashboard"
          />
          <Button text="success" className=" btn-success" link="/IntegratedDashboard" />
          <Button text="info" className=" btn-info" link="/IntegratedDashboard" />
          <Button text="warning" className=" btn-warning" link="/IntegratedDashboard" />
          <Button text="danger" className=" btn-danger" link="/IntegratedDashboard" />
          <Button text="Dark" className=" btn-dark" link="/IntegratedDashboard" />
          <Button text="Light" className=" btn-light" link="/IntegratedDashboard" />
          <Button
            text="White"
